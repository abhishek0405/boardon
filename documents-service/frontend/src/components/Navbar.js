...
function Navbar() {
  ...
  const handleSubmitLogin = async (e) => {
    ...
    if (employee.role === "user") {
      axios
        .post("http://localhost:3002/auth/user/login", employee, {
      ...
      axios
        .post("http://localhost:3002/auth/company/login", employee, {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${localStorage.getItem("authToken")}`,
          },
  ...
  const handleSubmitRegister = async (e) => {
    ...
    axios
      .post("http://localhost:3002/auth/company/register", company, {
        withCredentials: true,
        headers: {
          Authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
    ...
    <div className="Navbar">
      <div className="navbar-bg">
        ...
        <div className="login-modal">
          <button
            className="blue-btn"
            style={{ position: "absolute", left: "94%", top: "30%" }}
          ...
          >
            {state === true ? (
              ...
              <div
                ...
                style={{
                  width: "200px",
                  height: "200px",
                  backgroundImage: "linear-gradient(#4C00FF, #aa85ff",
                  position: "absolute",
                  left: "68%",
                }}
              ></div>
            ...
            <form onSubmit={handleSubmitLogin}>
              ...
              <label style={{ fontSize: 16, paddingRight: 5 }}>
                Login as:{" "}
              </label>
              ...
              {state === true ? (
                <label style={{ fontSize: 14 }}> Employee</label>
              ) : (
                <label style={{ fontSize: 16 }}> Company</label>
              )}
        ...
        <div className="get-started-modal">
          <button
            className="blue-btn"
            style={{ position: "absolute", left: "85%", top: "30%" }}
          ...
          >
            ...
            <form onSubmit={handleSubmitRegister}>
              <div class="login__field">
                ...
                />
                {nameError !== "" ? (
                  <p style={{ fontSize: 12, color: "red" }}>{nameError}</p>
                ) : (
                  <p></p>
                )}
              </div>
